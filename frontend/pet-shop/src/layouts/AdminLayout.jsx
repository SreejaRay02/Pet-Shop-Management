...
const navItems = [
  ...
  { label: 'Pets', to: '/admin/pets', icon: 'bi-box-seam' },
  { label: 'Categories', to: '/admin/categories', icon: 'bi-tags' },
  { label: 'Customers', to: '/admin/customers', icon: 'bi-people' },
  { label: 'Addresses', to: '/admin/addresses', icon: 'bi-geo-alt' },
  { label: 'Suppliers', to: '/admin/suppliers', icon: 'bi-truck' },
  { label: 'Employees', to: '/admin/employees', icon: 'bi-person-badge' },
  { label: 'Vaccinations', to: '/admin/vaccinations', icon: 'bi-eyedropper' },
  { label: 'Grooming', to: '/admin/grooming', icon: 'bi-scissors' },
  { label: 'Pet Foods', to: '/admin/foods', icon: 'bi-basket' },
  { label: 'Transactions', to: '/admin/transactions', icon: 'bi-receipt' },
];
  ...
  const SidebarContent = () => (
    <div className="d-flex flex-column h-100 bg-body-tertiary border-end shadow-sm"  style={{ width: '280px' }}>
      <div className="p-3 border-bottom d-flex align-items-center gap-2 text-primary fw-bolder fs-5 text-nowrap" >
        <i className="bi bi-suit-heart-fill" ></i> PetShop Admin
      </div>
      ...
      <div className="flex-grow-1 d-flex flex-column overflow-hidden min-vh-100" >
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary border-bottom shadow-sm px-3 py-2 d-flex align-items-center justify-content-between" sticky="top" >
          <div className="d-flex align-items-center gap-2" >
            ...
            <h5 className="mb-0 fw-bold d-none d-sm-block" >Admin Panel</h5>
          </div>
